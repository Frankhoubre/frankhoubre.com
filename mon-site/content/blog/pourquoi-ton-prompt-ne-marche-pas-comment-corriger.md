...
---
Tu es ici pour : Pourquoi ton prompt ne marche pas, et comment le corriger. Bien. On va éviter deux pièges tout de suite.
...
Pour Pourquoi ton prompt ne marche pas, et comment le corriger, garde une règle simple. Une décision forte vaut trois compromis. Une source lumineuse claire vaut dix adjectifs. Un export avec une histoire de fichiers propre vaut une nuit de chaos.
...
Pour Pourquoi ton prompt ne marche pas, et comment le corriger, sépare parfois en deux passes : lumière d’abord, détail ensuite.
