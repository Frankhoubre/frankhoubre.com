    ...
    <>
      ...
      <section className="relative isolate overflow-hidden border-b border-zinc-800 bg-zinc-950">
        ...
        <div className="relative mx-auto grid w-full max-w-6xl gap-12 px-4 py-20 sm:px-6 sm:py-24 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
              J&apos;accompagne les entreprises et boîtes de prod pour optimiser leur production avec
              l&apos;IA
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/85">
              Intervention orientée résultat pour améliorer trois leviers stratégiques :{" "}
              <strong>qualité de production</strong>, <strong>maîtrise des coûts</strong> et{" "}
              <strong>vitesse d&apos;exécution</strong>.
            </p>
          ...
          <aside className="ds-card rounded-3xl p-6 sm:p-7">
            ...
            <dl className="mt-5 space-y-4 text-sm">
              ...
              <div>
                <dt className="font-medium text-zinc-900">Déplacements</dt>
            ...
            <p className="mt-6 text-sm leading-relaxed text-zinc-700">
              Objectif : déployer une stratégie IA claire et actionnable pour obtenir des gains
        ...
        {galleryImages.length > 0 ? (
          <div className="relative mx-auto mt-2 w-screen max-w-[100vw] -translate-x-1/2 left-1/2 pb-10 sm:pb-12">
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-20">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-semibold tracking-tight text-neutral-950">
            Une prestation orientée performance opérationnelle
          </h2>
          <p className="mt-4 text-lg leading-relaxed text-neutral-800">
            Je travaille avec des équipes dirigeantes, des studios, des agences et des boîtes de
            production qui veulent intégrer l&apos;IA sans improvisation. L&apos;accompagnement se
            concentre sur les décisions qui ont un impact direct sur les délais, le budget et la
            qualité.
          </p>
        </div>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 px-4 py-14 sm:px-6 sm:py-20 lg:grid-cols-[1fr_1fr] lg:items-center">
          ...
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight text-neutral-950">
              Conseil stratégique + exécution terrain
            </h2>
        ...
        <div className="rounded-3xl border border-zinc-200 bg-white p-8 shadow-sm sm:p-10">
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3">
            ...
            <p className="text-sm text-zinc-600">
              Tarif fixe : <strong>4 200 € HT / jour</strong>, en distanciel, Paris, Strasbourg,
