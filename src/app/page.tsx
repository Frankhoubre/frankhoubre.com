  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <section className="mx-auto max-w-5xl px-4 pt-16 pb-12 sm:px-6 sm:pt-20 sm:pb-16">
        ...
        <h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-tight text-neutral-950 sm:text-5xl sm:leading-[1.1]">
        ...
        <p className="mt-6 max-w-2xl text-lg leading-relaxed text-neutral-800">
          ...
          <span className="font-medium text-neutral-950">{siteName}</span> :
          articles sur les workflows d’IA générative, le prompting et le réalisme
          visuel, du portrait à la vidéo.
        </p>
        <div className="mt-10 flex flex-wrap items-center gap-4">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-full border border-neutral-300 bg-white px-6 py-3 text-sm font-medium text-neutral-950 transition hover:border-neutral-400 hover:bg-neutral-50"
          >
            Contact
          </Link>
        </div>
