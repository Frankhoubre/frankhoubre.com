...
- locale: fr
- url: https://frankhoubre.com/blog/studios-traditionnels-vs-studios-ia-2026
- category: analyses
- type: evergreen (plan 90j J25), analyse sectorielle, 3486 mots, 10 H2, FAQ 7 questions
- search_intent: informationnelle (structure de production, qui fabrique quoi)
- primary_keyword: studio ia cinéma
- secondary_keywords: hollywood ia 2026, studio natif ia, accord disney openai, netflix ia générative règles, lionsgate runway, critterz
- sources: thewaltdisneycompany.com/news/disney-openai-sora-agreement (licence de 3 ans, plus de 200 personnages animés, masqués et créatures Disney, Marvel, Pixar, Star Wars avec costumes, accessoires, véhicules et décors ; exclusion explicite de toute ressemblance et de toute voix de talent ; investissement d'1 milliard de dollars assorti de bons de souscription ; déploiement annoncé début 2026) ; help.openai.com/en/articles/20001152 (web et application Sora arrêtés le 2026-04-26, API arrêtée le 2026-09-24 ; capture publiée) ; variety.com, mars 2026 (Disney renonce à l'investissement d'1 milliard) ; screendaily.com, règles Netflix publiées le 2025-08-26 (5 principes directeurs dont « le matériel généré reste temporaire et ne fait pas partie des livrables finaux », plus 4 familles de cas soumis à validation écrite : données, sortie créative, talents et performances, éthique et représentation) ; runway.com/news/runway-and-lionsgate-expand-partnership, 2026-06-11 (participation de Lionsgate au capital, programme de développement conjoint, premier projet = série épisodique au format court tirée d'IP existantes ; capture publiée) ; thewrap.com, 2025 (catalogue Lionsgate jugé trop petit pour entraîner un modèle) ; france24.com via AFP, septembre 2025 (Critterz : budget annoncé sous 30 M$, 9 mois visés, Vertigo Films + Native Foreign, financé par Federation Studios, comparaison 100-200 M$ et 3 ans pour un long d'animation majeur) ; screendaily.com et bloomberg.com, mai 2026 (AGC Studios prend les ventes mondiales au Marché du Film, première manquée à Cannes après la fermeture de Sora, sortie visée au T1 2027) ; businesswire.com et variety.com, juillet 2025 (Moonvalley 84 M$ levés, total 154 M$, General Catalyst avec CAA, CoreWeave et Comcast Ventures) ; cnc.fr, observatoire de l'IA. Tout relevé le 2026-09-07
- internal_links: -> /blog/lionsgate-runway-ai-series-courtes-ip-hollywood-2026, -> /blog/google-a24-partenariat-ia-outils-cinema-2026, -> /blog/sora-api-arret-septembre-2026-alternatives-createurs, -> /blog/2026-06-19-cnc-rapport-ia-cinema-audiovisuel-2026, -> /blog/combien-coute-court-metrage-ia-2026, -> /blog/metiers-audiovisuel-ia-menaces-transformation-avis, -> /blog/voidborn-anime-ia-festival-coulisses ; liens réciproques ajoutés DEPUIS lionsgate-runway-ai-series-courtes-ip-hollywood-2026 (fin de « Ce que ça révèle sur l'industrie en 2026 », avec la mise à jour du 11 juin 2026) et google-a24-partenariat-ia-outils-cinema-2026 (fin de « Ce qu'il reste à surveiller »)
- cta: aucun CTA produit, renvoi interne vers les articles du cluster industrie et vers l'analyse de coût
- cannibalization_notes: quatre voisins vérifiés. lionsgate-runway-ai-series-courtes-ip-hollywood-2026 et google-a24-partenariat-ia-outils-cinema-2026 gardent chacun LEUR deal traité en actualité. sora-api-arret-septembre-2026-alternatives-createurs garde la MIGRATION TECHNIQUE et les moteurs de repli. 2026-06-19-cnc-rapport-ia-cinema-audiovisuel-2026 garde le rapport du CNC. metiers-audiovisuel-ia-menaces-transformation-avis garde les métiers. Ce nouvel article ne traite QUE la structure de production : qui fabrique quoi, à quel format, avec quel modèle économique, et pourquoi la propriété du moteur est le critère qui trie. Il se lie aux quatre et deux d'entre eux lui renvoient. Risque résiduel faible
- editorial_notes: RÉORIENTATION MAJEURE PAR RAPPORT AU PLAN, point le plus important de ce run. Le plan écrit en juillet visait un comparatif de puissance adossé aux deals Lionsgate/Runway et Google/A24. Vérification faite le 2026-09-07, le fait central de 2026 a changé : OpenAI a arrêté Sora et Disney a renoncé à son investissement d'un milliard et à l'accord de licence signé en décembre 2025. L'angle est devenu « annonces contre livrables ». Chiffres écartés faute de source solide : le « aucun argent n'avait changé de main » entre Disney et OpenAI (vu seulement chez des agrégateurs), les gains de coût revendiqués par Toonstar (chiffres de vendeur non audités), et la première d'un film Asteria à Tribeca en juin 2026 (source unique non fiable). L'article écrit explicitement que les 30 M$ et les 9 mois de Critterz sont des cibles de lancement et pas un coût de revient audité, et qu'aucun compte de production n'a été publié. Images : hero Nano Banana 2 (grand plateau de tournage vide en journée, camions lumière et praticables au fond, une productrice seule à une table pliante au milieu du sol béton) plus deux captures d'écran réelles légendées avec source et date. PIÈGE OUTIL À RETENIR : .loop_scripts/screenshot_url.sh est codé en dur pour macOS et ne tourne pas sous Windows ; contournement par Chrome headless de C:/Program Files/Google/Chrome/Application/chrome.exe plus Pillow, script jetable dans le scratchpad, rien ajouté au repo. help.openai.com renvoie un challenge Cloudflare en headless sans user-agent (corrigé en passant un user-agent Chrome complet) et runway.com affiche un bandeau Cookiebot fixe en bas (corrigé en capturant en 1440x1800 puis en recadrant le haut)
- checker: pass (seo_audit 0 issue pour ce slug, editorial_audit score 100, bucket good, 0 flag, 0 tiret cadratin ; unslop-text 0 finding, plus passe manuelle FR sur les tells structurels : trois parallélismes négatifs supprimés, trois signposts supprimés, deux blocs en listes à en-têtes gras convertis en prose)
- published_commit: 4497cd0
...
- slug: outerframe-studio-pourquoi-studio-ia
- locale: fr
- url: https://frankhoubre.com/blog/outerframe-studio-pourquoi-studio-ia
- category: business
- type: evergreen / manifeste fondateur CAS (plan 90j J27). Publié le 2026-09-09 comme prévu, le calendrier ne glisse pas, donc J28 = 2026-09-10 (jour UPDATE midjourney-guide-complet)
- search_intent: navigationnelle et preuve (quelqu'un qui cherche ce qu'est Outerframe Studio, plus le créateur IA qui se demande s'il doit sortir du solo et monter une structure)
- primary_keyword: outerframe studio
- secondary_keywords: monter un studio ia, structure juridique création ia, sas ou micro-entreprise créateur, droits images générées ia, studio ia solo, statut freelance vidéo ia
- sources: screenweaver.ai/legal relevé le 2026-09-09 (Outerframe Studio, SAS, RCS de Strasbourg, 91 route des Romains 67200 Strasbourg, SIREN 101 716 447, TVA FR60101716447, capital 5 000 €, Frank Houbre président et directeur de la publication, hébergeur Vercel) ; screenweaver.ai/about (studio basé à Strasbourg, équipe de réalisateurs et d'ingénieurs, soutien du programme ElevenLabs Startup Grants, capture publiée dans l'article) ; screenweaver.ai/press (Frank Houbre ET Thibaut Dumont listés tous deux « Co-founder, ScreenWeaver / Outerframe Studio », ScreenWeaver en open beta, Lost Garden comme référence créative pendant le développement) ; elevenlabs.io/grants (33 M de caractères, 12 mois d'accès, sociétés de moins de 25 salariés, agences exclues) ; entreprendre.service-public.gouv.fr/actualites/A18813 (seuils micro-entreprise 2026-2028 : 83 600 € en prestations de services contre 77 700 € auparavant, 203 100 € en vente ; capture publiée dans l'article) ; entreprendre.service-public.gouv.fr/vosdroits/F37366 (SAS : capital libre dès 1 €, responsabilité limitée aux apports, président assimilé salarié au régime général avec les cotisations d'un salarié cadre sauf assurance chômage) ; entreprendre.service-public.gouv.fr/vosdroits/F21746 (franchise en base de TVA services 2026 inchangée, 37 500 € de base et 41 250 € majoré). Les prix de VOIDBORN sont exactement ceux déjà publiés sur voidborn-anime-ia-festival-coulisses, aucun ajouté. Aucun chiffre personnel inventé : les fabrications du premier jet (sept plateformes, quatre pages de pipeline, deux journées, trois semaines, quarante minutes) ont été retirées à la relecture
- internal_links: -> lost-garden-journal-production-serie-ia, ronces-coulisses-court-film-ia, voidborn-anime-ia-festival-coulisses, screenweaver-pourquoi-outil-ecriture, erreurs-premiers-films-ia-lecons, monetiser-competences-creation-ia-freelance-agence, studios-traditionnels-vs-studios-ia-2026, /prestation. Le lien vers /presse prévu au plan a été remplacé (route inexistante). Liens entrants réciproques ajoutés depuis lost-garden-journal-production-serie-ia (fin de « Ce que je referais autrement ») et screenweaver-pourquoi-outil-ecriture (fin de « Ce que construire mon propre outil m'a appris »)
- cta: soft CTA vers /prestation en fin de section « Si tu hésites », posé après la phrase qui dit que la structure n'a fait venir aucun client et que c'est le travail publié qui les amène. ScreenWeaver mentionné comme produit édité par le studio, pas comme argument de vente
- cannibalization_notes: screenweaver-pourquoi-outil-ecriture garde L'HISTOIRE PRODUIT (pourquoi cet outil existe, ce qu'il fait, ce qu'il ne fait pas) ; studios-traditionnels-vs-studios-ia-2026 garde LE PANORAMA SECTORIEL (qui produit quoi chez les majors et les studios natifs) ; comment-creer-agence-creation-video-ia garde LE MODÈLE AGENCE (positionnement, offres, staffing) ; monetiser-competences-creation-ia-freelance-agence garde LE PRICING et le packaging d'offres. Ce fichier ne traite QUE la bascule du solo vers une structure et le choix du statut juridique, et la distinction est écrite dans le corps. Angle différenciant : les contenus français sur « monter un studio IA » restent au niveau de l'intention, l'article adosse chaque décision à une contrainte publiée et vérifiable (seuil de CA, régime social du dirigeant, question client sur les droits)
- checker: pass (seo_audit 0 issue pour ce slug, editorial_audit score 100 / bucket good / 0 flag / 3138 mots / 9 H2 / 11 liens internes / 5 externes / 3 images / 0 tiret cadratin, lint 0 err, typecheck PASS, build PASS avec la route /blog/outerframe-studio-pourquoi-studio-ia générée, build_ledger régénéré 307 FR 232 EN). Fichier écrit en LF, les deux articles recevant un lien entrant normalisés en LF au passage. Images : hero Nano Banana 2 (bureau de studio au premier étage à Strasbourg au petit matin, fenêtre sur façades à colombages, deux fondateurs devant un mur de planches de storyboard aimantées, cartons non ouverts) puis DEUX VRAIES CAPTURES conformément à la priorité captures : screenweaver.ai/about recadrée sur le paragraphe « Who we are » et le tableau officiel des seuils micro-entreprise sur entreprendre.service-public.gouv.fr, vérifiées à l'écran et légendées avec source et date. Bannière cookies contournée en rendant la page en fenêtre haute puis en recadrant au-dessus de la bannière avec PIL. Un seul fichier source touché, src/app/a-propos/page.tsx, pour ajouter Outerframe en worksFor Organization au JSON-LD Person (le sameAs demandé au plan a été écarté, Outerframe n'ayant pas d'URL propre)
- published_commit: e4df54a

- slug: pourquoi-courts-metrages-ia-oubliables
- locale: fr
- url: https://frankhoubre.com/blog/pourquoi-courts-metrages-ia-oubliables
- category: analyses
- type: evergreen / opinion OPINION (plan 90j J38). Prévu le 2026-09-22, publié le 2026-09-23 (aucun run le 22) : le calendrier glisse d'un jour, donc J39 = 2026-09-24 (screenweaver-lecons-saas-creatif, CAS, MOYENNE)
- search_intent: info, le créateur qui a fini un court métrage IA correct techniquement et qui se demande pourquoi il ne laisse aucune trace
- primary_keyword: court métrage ia qualité
- secondary_keywords: pourquoi les courts métrages ia sont oubliables, durée court métrage ia, rythme montage ia, design sonore film ia, look par défaut modèles vidéo, festival film ia durée
- sources: dépêche AP relayée par ny1.com le 2026-06-06 (AI Film Festival de Runway, ~300 films déposés à la 1re édition en 2023, ~6 000 pour l'édition 2025, 10 projetés à Alice Tully Hall le 5 juin 2025, Grand Prix Total Pixel Space de Jacob Adler 9 min 28, compositeur enseignant à l'Arizona State University) ; aif.runwayml.com relevé le 2026-09-23 (palmarès 2026 avec durées 7:50 / 5:29 / 5:04 / 4:19 / 8:21 / 7:00 / 7:39, règlement 3 à 15 minutes, Grand Prix 50 000 $) ; support.google.com/youtube/answer/1311392 relevé en français le 2026-09-23 (notice du 15 juillet 2025, « contenu répétitif » renommé « contenu non authentique », étendu aux contenus « répétitifs ou produits en masse ») ; palmarès de VOIDBORN repris du site (Seoul International AI Film Festival, Hollywood Indie Festival, Australian AI Festival). AUCUNE durée maximale de modèle citée : specs par modèle non confirmées sur doc officielle ce jour
- internal_links: -> festivals-films-ia-criteres-jurys, comment-passer-rendu-amateur-a-cinema-ia, comment-diriger-personnage-ia-comme-acteur, choisir-bonne-duree-plan-selon-intention-ia, gerer-profondeur-sons-ambiances-court-metrage-ia, voidborn-anime-ia-festival-coulisses, erreurs-premiers-films-ia-lecons, creer-court-metrage-100-ia-sans-camera-acteurs, /formation-ia-gratuite. Entrants réciproques (dateModified 2026-09-23) depuis comment-passer-rendu-amateur-a-cinema-ia (fin de « Passe 5 : rejet ») et erreurs-premiers-films-ia-lecons (fin de la check-list)
- cta: CTA doux AI Studios vers /formation-ia-gratuite, posé après le protocole en 8 étapes sur les seuls points 1 à 3 (ceux qui ne coûtent rien). Aucune mention ScreenWeaver ni Imaginode, l'article ne s'y prêtait pas
- cannibalization_notes: comment-passer-rendu-amateur-a-cinema-ia garde LE RENDU, et l'article dit explicitement qu'aucune de ses six causes ne concerne l'image ; erreurs-premiers-films-ia-lecons garde le REX personnel des trois films (Ronces, VOIDBORN, Lost Garden) ; festivals-films-ia-criteres-jurys garde LA GRILLE DE NOTATION des jurys, renvoi explicite et aucun critère re-traité ici ; creer-court-metrage-100-ia-sans-camera-acteurs garde le tutoriel de fabrication ; film-ia-erreurs-raccord garde la check-list de continuité. Cet article ne porte que le diagnostic « pourquoi ça ne reste pas », vu du spectateur
- editorial_decisions: le pourcentage du titre du plan (« 95 % ») est retiré du titre et de l'article, aucune source ne le publie ; un paragraphe dédié l'assume et donne le seul rapport dur disponible (10 sur 6 000). Les observations personnelles (le lot de courts vus chaque semaine, les deux survivants) sont présentées comme une opinion de praticien et pas comme une mesure. La fausse précision « une quarantaine de films » a été retirée à la passe antislop-copywriting. La citation YouTube a été réécrite d'après la page française capturée plutôt que d'après la formulation anglaise
- checker: pass (seo_audit 0 issue pour ce slug, editorial_audit score 100 / bucket good / 0 flag / 4524 mots / 14 H2 / 3 externes / 3 images / 0 tiret cadratin, lint 0 err avec 1 warning préexistant, typecheck PASS, build PASS article prérendu, CONTENT_INDEX régénéré 317 FR / 232 EN / 0 undefined)
- published_commit: b0658a6

- slug: screenweaver-lecons-saas-creatif
- locale: fr
- url: https://frankhoubre.com/blog/screenweaver-lecons-saas-creatif
- category: business
- type: evergreen / REX build in public CAS (plan 90j J39). Publié à la date prévue le 2026-09-24, le calendrier ne glisse pas, J40 = 2026-09-25.
- search_intent: info, le créateur ou freelance qui envisage de construire son propre outil créatif et veut le coût réel avant de s'engager.
- primary_keyword: créer saas créatif
- secondary_keywords: construire un saas ia, build in public créatif, économie unitaire saas ia, crédits ia tarification, lancer un outil pour créateurs
- sources: dépôt local ScreenWeaver-App relevé le 2026-09-24 (premier commit 2026-01-22 Vite + React, « migration to next js » le 2026-01-23, PR #18 Yjs fusionnée le 2026-05-19, migration workspace vers shards en juin 2026, widget de support embarqué le 2026-09-14, 1034 commits, 676 fichiers de test, commits par mois 41/88/40/20/106/322/258/100/59) ; screenweaver.ai relevé et capturé le 2026-09-24 (Screenwriter 0 $, Storyboard Beta 9,99 $/mois, Filmmaker « Coming soon » ciblé au 30 septembre 2026, production vidéo indisponible pendant la bêta, palmarès VOIDBORN / Les Fils du Vinnana / Lost Garden festival par festival) ; imaginode.ai/fr/pricing relevé et capturé le 2026-09-24 (1 crédit ~ 0,01 EUR, 13/42/145 EUR HT pour 900/3 100/10 500 crédits, crédit 7 % et 6 % moins cher, crédits mensuels expirant au renouvellement, recharges sans date limite, mensuels dépensés en premier, génération ratée remboursée, coût affiché avant le clic) ; docs.yjs.dev.
- internal_links: -> screenweaver-pourquoi-outil-ecriture, screenweaver-vs-final-draft, screenweaver-ai-ecriture-scenario-storyboard, outerframe-studio-pourquoi-studio-ia, pourquoi-jai-construit-imaginode-canvas-ia, budgeter-projet-video-ia-methode, voidborn-anime-ia-festival-coulisses, lost-garden-univers-coherent-episodes, concours-lepine-lecons-innovation (12 liens au total). Entrants réciproques ajoutés depuis screenweaver-pourquoi-outil-ecriture (fin de « Ce que je referais pareil ») et pourquoi-jai-construit-imaginode-canvas-ia (fin de la FAQ), dateModified 2026-09-24 sur les deux, fichiers normalisés en LF.
- cta: aucun CTA commercial dur. Les deux produits sont le sujet de l'article, ils sont traités en matériau d'étude (dates ratées, marges, limites) et non en argumentaire ; pas de lien vers /prestation ni vers /formation-ia-gratuite.
- cannibalization_notes: screenweaver-pourquoi-outil-ecriture (J13) garde la vision produit et le « pourquoi », l'article y renvoie dès l'introduction ; J39 ne porte que le versant business et technique, avec des données de dépôt qui n'existent nulle part ailleurs sur le site. pourquoi-jai-construit-imaginode-canvas-ia garde le workflow du canvas, J39 n'en reprend que le modèle de crédits. construire-en-public-studios-outils-films (J62) reste à écrire comme manifeste, pas comme REX chiffré.
- editorial_decisions: le titre du plan (« leçons d'un SaaS créatif construit en solo ») est corrigé parce que ScreenWeaver est co-créé avec Thibaut et édité par Outerframe Studio ; le titre publié est « Créer un SaaS créatif : les leçons de ScreenWeaver » et un H2 entier fait de la correction une leçon, en opposant ScreenWeaver (à deux) à Imaginode (réellement solo). Slug conservé. Aucun chiffre d'utilisateurs, de CA ni de conversion publié, faute de source vérifiable. Trois fausses précisions du premier jet retirées (« onze heures sur un bug », « 200 euros de coût par abonné », « des milliers de pages »). L'article assume publiquement la date « fin août 2026 » écrite le 2026-08-21 sur ce blog pour l'offre Filmmaker et en fait la leçon centrale sur les annonces ; la phrase d'août reste en ligne.
- checker: pass (seo_audit 0 issue sur les 3 slugs touchés, editorial_audit score 100 / bucket good / 0 flag / 3586 mots / 9 H2 / 12 liens internes / 3 externes / 3 images / 0 tiret cadratin, lint 0 err avec 1 warning préexistant, typecheck PASS, build PASS 627 pages avec article prérendu, CONTENT_INDEX régénéré 318 FR / 232 EN / 0 undefined)
- published_commit: 482e909
