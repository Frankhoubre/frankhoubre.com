...
1. **Result**: does it pass the internal validation?
2. **Time**: do you reduce the calendar uncertainty?
3. **Responsibility**: do you own it if it goes sideways?
...
1. **Client context** in two sentences (not a novel).
2. **Creative hypothesis**: what we test, what we refuse.
3. **Deliverables**: files, formats, number of versions.
4. **Process**: workshops, validations, client feedback delays.
5. **Risks**: voice, faces, brands, music rights.
6. **Price**: package + options + overage.
...
For the acquisition strategy and the positioning, link our article on [how to find clients for AI videos](/en/blog/comment-trouver-clients-video-ia-acquisition).
...
For the legality of selling images and the gray areas, see our guide on the [legality of selling AI-generated images](/en/blog/vendre-images-generees-ia-legalite).
...
![Quote and planning on a desk, coffee cup, tablet with moodboard, photorealistic boutique agency atmosphere](/images/blog/monetiser-competences-creation-ia-freelance-agence/workflow-devis.webp)
...
For the European frame that increasingly influences sensitive briefs, keep a stable reference: [European Commission AI strategy](https://digital-strategy.ec.europa.eu/en/policies/european-approach-artificial-intelligence). For a cross-cutting reading on the societal and educational impacts, see also [UNESCO AI](https://www.unesco.org/en/artificial-intelligence).

For a grid of ideas on video pricing, see our article on [how much to bill for a professional AI video](/en/blog/combien-facturer-video-ia-professionnelle-grille-prix).

![Contract signature and annotated storyboard, hand holding a pen, end-of-day office light photorealistic](/images/blog/monetiser-competences-creation-ia-freelance-agence/workflow-contrat.webp)
...
If an AI supplier cuts a service, who pays the delay? A simple line avoids the drama: replacement options, substitution delays, and a liability cap consistent with your price. To understand why the models sometimes "jump" version, keep an eye on the recent technical literature via [arXiv](https://arxiv.org/): it is not law, but it helps you explain to the client that the tool is not an immovable rock.
...
You refuse. It is not a moral stance: it is a business protection. Read our article on [forbidden fake AI UGC testimonials](/en/blog/pourquoi-faux-temoignages-ugc-ia-interdits) and keep a trace of your refusal.
