...
Le troisième concept, c’est la contrainte de production intégrée à l’écriture. Mais c’est là que tout se casse : la plupart des débutants écrivent un scénario “idéal”, puis tentent de le rendre faisable après coup. Mauvaise approche. Tu dois intégrer dès le prompt la réalité de tournage: 2 lieux, 2 à 3 personnages, 2 jours de prod, peu d’effets fragiles. Ton script devient plus fort, pas plus pauvre.

Le quatrième concept, c’est l’action visuelle comme langage principal. Un bon scénario IA n’est pas un PDF bavard. C’est un plan de mise en scène implicite. Si ta scène ne fonctionne pas sans dialogue, elle est fragile. Pour renforcer cette logique visuelle, appuie-toi sur [notre guide comparatif Flux et SDXL pour des images réalistes](/blog/flux-vs-sdxl-quelle-ia-choisir-images-realistes), [notre méthode pour créer un univers visuel cohérent avec l’IA](/blog/comment-creer-univers-visuel-coherent-avec-ia), et [notre workflow complet d’idée à film IA réaliste](/blog/workflow-complet-idee-film-ia-realiste). Pour passer du texte aux images de prévisualisation, [notre guide de storyboarding IA](/blog/storyboarding-ia-vision-cinematographique) aide à verrouiller des plans avant d’écrire dans le vide.

Le cinquième concept, c’est la **gestion du sous-texte** comme compétence première. L’IA a tendance à nommer les émotions au lieu de les montrer. Ton travail consiste à imposer des contraintes de *non-dit* : interdiction d’expliquer la peur, obligation de la traduire en geste, regard, retard à la réponse. Ce décalage produit des scènes jouables. Le sixième concept est la **réécriture comme sport** : une bonne session n’est pas celle qui produit trente pages, celle qui transforme trois beats critiques avec une décision claire à chaque fois.
...
Enfin, impose une passe anti-cliché. Dis explicitement: “Liste les clichés narratifs de cette structure et remplace-les par des alternatives ancrées dans le réel.” Regarde ce qui se passe quand tu fais ça : le niveau monte immédiatement.
...
### Étape 5: verrouiller la voix d’auteur et une bible anti-générique

Avant d’écrire des répliques, crée une **bible de voix** en cinq lignes par personnage : rythme de phrase, lexique favori, mécanisme de défense sous stress, sujet tabou, et mensonge qu’il se raconte. Ce document n’est pas littéraire. Il est opérationnel. Tu le colles en tête de chaque session IA comme contrat. Quand une réplique sonne *trop polie*, ce n’est pas un accident : c’est que le modèle optimise la politesse par défaut. Tu dois réinjecter la faille.

Ajoute aussi une liste courte de **phrases interdites** : formulations explicatives du type *je ressens que*, *au fond je crois que*, *tu sais ce que c’est*. Ce sont des fuites d’intérieur qui tuent le cinéma. Remplace-les par des actions ou des silences. Puis impose une règle de **réécriture en deux passes** : passe A pour le sens, passe B uniquement pour le sous-texte et la dureté. La plupart des débutants mélangent les deux et obtiennent un texte mou.

Enfin, documente une **promesse de spectateur** en une ligne : *à la fin, je veux que le public se demande si X va oser Y*. Si une scène ne nourrit pas cette question, elle est candidate à la coupe, même si elle est belle. Cette discipline paraît froide. Elle est en réalité ce qui protège ton émotion.

### Étape 6: passer du beat sheet au découpage technique minimal

Quand ton beat sheet tient debout, fais un **découpage léger** : nombre de scènes, lieux, plages horaires fictives, et transitions. Tu n’écris pas encore le plan à plan. Tu vérifies si ton histoire est *filmable* sans gymnastique. Si tu dois changer de ville trois fois en huit minutes, tu n’as pas un problème d’IA. Tu as un problème de cadrage de production.

Demande ensuite à l’IA une **liste de risques** : quels beats sont les plus difficiles à jouer, à cadrer, ou à monter. Utilise cette liste pour ajuster avant d’écrire des pages entières. C’est une étape rarement enseignée aux débutants, parce qu’elle n’est pas glamour. Elle évite pourtant les scripts magnifiques sur le papier et impossibles sur le plateau.
...
Problème 6: **surexplication des enjeux** dans les cinq premières minutes. Correction: déplace l’information vers des preuves visuelles et des gestes. Garde une seule phrase d’orientation maximum au début, puis impose l’action.

Problème 7: **ton uniforme** entre tous les personnages. Correction: réécris chaque scène avec une contrainte de voix différente (bavard vs sec, ironique vs littéral) et fais relire à voix haute en changeant de lecteur.
...
L’objectif n’est pas de collectionner des frameworks. L’objectif est de produire un script tournable, lisible, émotionnellement précis. Si tu ne fais qu’une chose après lecture : écris ta promesse finale sur un post-it et refuse toute scène qui ne la nourrit pas.
