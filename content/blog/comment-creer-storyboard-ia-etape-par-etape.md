...
Pour la couche rédactionnelle complète avant le découpage, [comment écrire un scénario de court métrage avec l'IA de A à Z](/blog/comment-ecrire-scenario-court-metrage-ia-a-z) reste une rampe utile si tu dois verrouiller structure, pivots dramatiques et silences jouables.
...
Pour les équipes qui poussent la cohérence « même visage partout », [workflow Nano Banana pour personnages cohérents](/blog/workflow-nano-banana-personnages-coherents) détaille une chaîne de fiches et de QA qui transpose très bien au storyboard : même esprit, autres livrables.
...
![Workflow IA : lots courts, annotations techniques et validation par bloc](/images/blog/comment-creer-storyboard-ia-etape-par-etape/workflow-1.webp)
...
![Animatique et test de rythme après storyboard IA](/images/blog/comment-creer-storyboard-ia-etape-par-etape/workflow-2.webp)

## Table : diagnostic rapide quand un plan « ne passe » pas

| Symptôme observé | Cause probable | Correctif prioritaire |
| ---------------- | -------------- | --------------------- |
| Visage « wax » ou trop lisse | surcharge esthétique / beauté implicite | interdits plus clairs + texture peau + lumière latérale |
| Saut de costume entre cases | synonymes dans les prompts | revenir à la bible mot pour mot |
| Même taille de plan partout | absence de fonction par case | réécrire la fonction puis recadrer |
| Décors qui pivotent | pas d'ancrage architectural | ajouter trois invariants géométriques dans chaque prompt |
| « On ne sait pas qui regarde qui » | axe de regard non contraint | corriger direction des pupilles et position des corps |
| Image belle mais illisible narrativement | décoratif sans enjeu | supprimer ou fusionner avec un plan d'ancrage |
...
- [American Society of Cinematographers](https://theasc.com/) pour approfondir le langage de la lumière et des intentions photographiques avec sérieux.
- [StudioBinder](https://www.studiobinder.com/) pour la logique storyboard et checklist production côté méthode.

Si tu dois verrouiller la grammaire plan et transitions sans déraper dans la théorie creuse, la zone éducative du [British Film Institute](https://www.bfi.org.uk/) aide aussi à stabiliser les termes que tu réinjectes dans tes prompts.
