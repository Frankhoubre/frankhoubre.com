...
## Secret 1 : une phrase sujet, une phrase lumière, une phrase caméra

Tu forces ton cerveau à hiérarchiser. Le sujet : qui, où, action minimale. La lumière : source, dureté, couleur. La caméra : focale, hauteur d’œil, distance.

Si tu mélanges tout en vrac, le modèle mélange tout en vrac aussi.

## Secret 2 : le vocabulaire optique bat le vocabulaire marketing

« Award winning » ne donne pas de géométrie. Préfère : **35 mm**, **f/2.8**, **ISO 400**, **légère motion** si cohérent avec la scène.
...
Trois lignes utiles valent mieux que trente interdictions contradictoires. Cible ce qui casse **ton** sujet : mains si visibles, dents si bouche ouverte, oversharpen si architecture.

## Secret 4 : une seule idée forte par image

« Coucher de soleil + néon + pluie + brouillard + foule + véhicule vintage » : c’est une recette de boue visuelle. Retire jusqu’à ce qu’il reste une hiérarchie claire.

Pour le contraste et la couleur après coup, [pourquoi tes images IA manquent de contraste et comment corriger](/blog/pourquoi-images-ia-manquent-contraste-comment-corriger).

## Tableau : mot piège, alternative utile

| Mot piège | Alternative |
| --- | --- |
| ultra detailed | matière précise (béton rugueux, laine feutrée) |
| cinematic random | hauteur caméra + focale |
| hyper realistic | lumière + texture peau mesurée |
| masterpiece | intention narrative en une ligne |

## Secret 5 : le test AB en deux minutes

Même seed si possible, un seul changement : par exemple fill plus froid. Tu notes lequel lit mieux en miniature. La miniature est le vrai test social.

## Approfondissement terrain : Les secrets des prompts pour générer des images au rendu photographique

Ce chapitre prolonge l’angle « Ce qui marche vraiment : hiérarchie d’information, vocabulaire optique, et pièges à éviter pour ne pas retomber sur un cliché IA. » pour le sujet réel derrière `secrets-prompts-rendu-photographique-ia`. L’objectif n’est pas d’empiler des adjectifs, mais d’installer une **boucle QA** courte que tu peux réutiliser sur chaque livrable : capture, note, compare, tranche, archive. La plupart des créateurs perdent du temps parce qu’ils mélangent trois variables en une session, puis blâment le modèle. Quand tu sépares lumière, composition, texture, intention, tu retrouves un diagnostic honnête et une progression mesurable.
...
Tu n’as pas besoin d’analytics complexes : compte le **temps moyen par itération**, le **taux d’abandon** (images jetées), et le **taux de validation du premier essai**. Si le premier essai est toujours rejeté, ton brief est probablement flou. Si tu jettes tout, ton protocole mélange trop de variables. Pour **Les secrets des prompts pour générer des images au rendu photographique**, ces métriques te disent si tu progresses ou si tu te déplaces latéralement.

### Escalade qualité : quand arrêter de regénérer

Arrête quand tu corriges un détail qui n’apparaît qu’à 400 % de zoom, sauf usage print géant. Arrête quand la géométrie est bonne mais que seule une micro-texture gêne : passe en post ciblée. Arrête quand tu changes de modèle pour fuir un problème de lumière : tu réinitialises tout le reste. Le slug `secrets-prompts-rendu-photographique-ia` doit rester un **projet maîtrisé**, pas une spirale.

### Archivage : ce qu’un futur toi remerciera

Archive : prompts principaux (même partiels), **deux captures** A/B annotées, la **liste des outils** et versions, et une phrase « pourquoi on a tranché ainsi ». Si tu livres à un client, un zip propre avec README court vaut mieux que dix fichiers mal nommés. Pour l’angle « Ce qui marche vraiment : hiérarchie d’information, vocabulaire optique, et pièges à éviter pour ne pas retomber sur un cliché IA. », l’archive prouve que tu as suivi un processus, pas seulement une intuition du moment.
...
### Faut-il écrire en anglais ?
Souvent oui pour les modèles entraînés majoritairement en anglais, mais teste ta langue si l’outil le permet.

### Les poids type (mot:1.2) servent-ils toujours ?
Dépend du moteur. Documente ce qui marche sur ton stack.

### Plus de steps égale mieux ?
Non, au delà d’un palier tu brûles du temps pour peu de gain.

### Le seed magique existe-il ?
Non. Bon brief + bon rejet + archive.

### Comment savoir si je sur-prompte ?
Si tu ne peux plus identifier ce qui changerait en premier, tu sur-promptes.

### Et le style « film argentique » ?
Une ligne pellicule + contraste global cohérent, pas dix filtres.

### Où aller après ce guide ?
