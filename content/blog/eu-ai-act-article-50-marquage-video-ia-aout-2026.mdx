...
Mise à jour du 20 septembre 2026 : l'ARPP a publié le 3 août une fiche pratique d'étiquetage des contenus publicitaires générés par IA, avec une grille à trois critères. Pour les annonceurs, elle est détaillée dans [le guide sur la publicité IA sans risque juridique pour les marques](/blog/marques-publicites-ia-risque-juridique), qui replace l'article 50 parmi les cinq questions à régler avant de diffuser une campagne générée.
