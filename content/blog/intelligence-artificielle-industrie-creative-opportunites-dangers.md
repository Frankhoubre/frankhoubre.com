...
![Réunion créative agence, murs moodboard, écran présentation data, ambiance sérieuse photoréaliste](/images/blog/intelligence-artificielle-industrie-creative-opportunites-dangers/hero.webp)
...
Pour la partie « vendre et encadrer » des visuels générés, relie notre guide sur la [légalité de la vente d'images générées par IA](/blog/vendre-images-generees-ia-legalite).
...
Sur les faux UGC et les zones interdites, lis notre article sur les [faux témoignages UGC IA et pourquoi c'est une ligne rouge](/blog/pourquoi-faux-temoignages-ugc-ia-interdits).
...
![Open space studio nuit, écrans calibrage couleur et storyboard digital, ambiance laboratoire créatif](/images/blog/intelligence-artificielle-industrie-creative-opportunites-dangers/workflow-validation.webp)
...
Les régulateurs ne vont pas valider ton moodboard. Ils vont lire tes process. Lis au minimum les lignes directrices européennes ([European Commission AI strategy](https://digital-strategy.ec.europa.eu/en/policies/european-approach-artificial-intelligence)) et garde une lecture transversale sur les impacts sociétaux ([UNESCO AI](https://www.unesco.org/en/artificial-intelligence)). Ce n'est pas une checklist légale complète, mais ça évite les angles morts évidents.

### Quand le portfolio ment

Si tu présentes des images « quasi réelles » sans cadre, tu entraînes le marché à mentir avec toi. Pour un cadre honnête de portfolio, voir notre guide [comment créer un portfolio IA crédible](/blog/comment-creer-portfolio-ia-credible).
...
Les zones grises ne disparaissent pas parce que l'outil est cool. Pour une base de lecture, l'[OMPI sur l'IA et la propriété intellectuelle](https://www.wipo.int/web-publications/wipo-primer-on-artificial-intelligence-and-ip/) aide à poser le vocabulaire, complété par notre article sur les [droits d'auteur et images générées](/blog/droits-auteur-images-generees-ia).
