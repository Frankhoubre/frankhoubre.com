...
metaTitle: "Studio IA cinéma 2026 : qui produit quoi, vraiment"
metaDescription: "Ce que les majors et les studios natifs IA ont réellement produit en 2026 : accords signés, films livrés, projets bloqués. Analyse sourcée de Frank Houbre."
tags: ["studio ia cinéma", "hollywood ia", "production ia", "industrie cinéma", "frank houbre"]
author: "Frank Houbre"
published: true
---
...
![Grand plateau de tournage vide avec camions lumière et praticables, une productrice seule à une table pliante devant son ordinateur](/images/blog/studios-traditionnels-vs-studios-ia-2026/hero.webp)
...
![Page d'aide officielle d'OpenAI annonçant l'arrêt de Sora, avec les dates du 26 avril et du 24 septembre 2026](/images/blog/studios-traditionnels-vs-studios-ia-2026/workflow-1.webp)
...
Le reste se joue en amont, dans des documents que la machine ne détient pas : bible visuelle, planches de références, charte d'étalonnage. C'est ce qui m'a sauvé sur [VOIDBORN](/blog/voidborn-anime-ia-festival-coulisses) quand j'ai jeté la première version réaliste. La direction artistique existait ailleurs que dans un historique de génération, donc la reconstruire n'a pas voulu dire tout réinventer.
...
Le quatrième, c'est la mesure côté français. Les baromètres du CNC et les notes d'emploi produites avec Audiens et l'Afdas sont pour l'instant la seule source publique qui regarde les effectifs réels plutôt que les annonces. C'est aussi le seul endroit où l'on pourra voir si les métiers bougent, sujet que je traite en détail dans [mon analyse des métiers de l'audiovisuel face à l'IA](/blog/metiers-audiovisuel-ia-menaces-transformation-avis).
...
- [OpenAI, page d'aide officielle sur l'arrêt de Sora](https://help.openai.com/en/articles/20001152-what-to-know-about-the-sora-discontinuation)
- [Runway, annonce de l'élargissement du partenariat avec Lionsgate, 11 juin 2026](https://runway.com/news/runway-and-lionsgate-expand-partnership)
- [The Walt Disney Company, communiqué sur l'accord avec OpenAI](https://thewaltdisneycompany.com/news/disney-openai-sora-agreement/)
- [Screen International, publication des règles Netflix sur l'IA générative](https://www.screendaily.com/news/netflix-releases-guidelines-for-using-generative-ai-in-productions/5208200.article)
- [CNC, Observatoire de l'intelligence artificielle](https://www.cnc.fr/professionnels/observatoire-de-lintelligence-artificielle_2390539)
