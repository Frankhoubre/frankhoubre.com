...
## Cause 1 : tu mélanges des vérités contradictoires

Soleil dur + reflets de néon + pluie + intérieur jour : le spectateur ne sait plus quelle loi physique croire. Le cerveau coupe l’empathie et classe « démo ».

**Correctif :** une **loi lumière** dominante par plan, une seconde source max lisible.

## Cause 2 : le mouvement caméra n’a pas de masse

Travelling hyper fluide sans vibration ni inertie : ça sent la caméra virtuelle par défaut.
...
Entre deux frames, les pores migrent. C’est plus visible que le décor.

**Correctif :** plans plus courts, visage moins serré, ou repasse sur une image source plus stable avant motion. Voir [comment améliorer le réalisme des mouvements en vidéo IA](/blog/comment-ameliorer-realisme-mouvements-video-ia).

## Cause 4 : le son trahit l’image

Bruit de chambre absent, pas de foley contextuel, musique stock : le cerveau classe « montage amateur » même si l’image est belle.

**Correctif :** ambiances minimalistes mais liées au lieu, pas une bed music générique.

## Tableau : signe, levier, priorité

| Signe | Levier | Priorité |
| --- | --- | --- |
| visage instable | cadrage / durée | haute |
| reflets impossibles | prompt lumière | haute |
| caméra « drone mental » | mouvement | moyenne |
| couleurs qui sautent | grade global | moyenne |

## Approfondissement terrain : Pourquoi mes vidéos IA manquent de réalisme

Ce chapitre prolonge l’angle « Lumière incohérente, texture qui glisse, mouvement de caméra invraisemblable, et son déconnecté : les causes les plus fréquentes. » pour le sujet réel derrière `pourquoi-videos-ia-manquent-de-realisme`. L’objectif n’est pas d’empiler des adjectifs, mais d’installer une **boucle QA** courte que tu peux réutiliser sur chaque livrable : capture, note, compare, tranche, archive. La plupart des créateurs perdent du temps parce qu’ils mélangent trois variables en une session, puis blâment le modèle. Quand tu sépares lumière, composition, texture, intention, tu retrouves un diagnostic honnête et une progression mesurable.
...
Tu n’as pas besoin d’analytics complexes : compte le **temps moyen par itération**, le **taux d’abandon** (images jetées), et le **taux de validation du premier essai**. Si le premier essai est toujours rejeté, ton brief est probablement flou. Si tu jettes tout, ton protocole mélange trop de variables. Pour **Pourquoi mes vidéos IA manquent de réalisme**, ces métriques te disent si tu progresses ou si tu te déplaces latéralement.

### Escalade qualité : quand arrêter de regénérer

Arrête quand tu corriges un détail qui n’apparaît qu’à 400 % de zoom, sauf usage print géant. Arrête quand la géométrie est bonne mais que seule une micro-texture gêne : passe en post ciblée. Arrête quand tu changes de modèle pour fuir un problème de lumière : tu réinitialises tout le reste. Le slug `pourquoi-videos-ia-manquent-de-realisme` doit rester un **projet maîtrisé**, pas une spirale.

### Archivage : ce qu’un futur toi remerciera

Archive : prompts principaux (même partiels), **deux captures** A/B annotées, la **liste des outils** et versions, et une phrase « pourquoi on a tranché ainsi ». Si tu livres à un client, un zip propre avec README court vaut mieux que dix fichiers mal nommés. Pour l’angle « Lumière incohérente, texture qui glisse, mouvement de caméra invraisemblable, et son déconnecté : les causes les plus fréquentes. », l’archive prouve que tu as suivi un processus, pas seulement une intuition du moment.
...
### 24 fps suffit-il ?
Souvent oui pour l’intention cinéma si le **mouvement** est cohérent.

### L’upscale vidéo rattrape-t-il ?
Rarement le réalisme. Au mieux la netteté, au pire le plastique.

### Faut-il toujours du grain ?
Un grain léger homogène aide souvent à cacher les micro-incohérences.

### Keyframe image d’abord ?
Oui dans beaucoup de workflows sérieux : [comment créer une vidéo cinématique avec l’IA étape par étape](/blog/comment-creer-video-cinematique-ia-etape-par-etape).
