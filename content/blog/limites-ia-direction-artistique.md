...
![Moodboard mural studio et écran références couleur, ambiance direction artistique photoréaliste](/images/blog/limites-ia-direction-artistique/hero.webp)
...
Pour structurer une vidéo avec une exigence de récit, voir [comment structurer une vidéo IA comme un vrai film](/blog/comment-structurer-video-ia-comme-vrai-film). Pour la pensée derrière le cadre, [comment penser comme un réalisateur avec l'IA](/blog/comment-penser-comme-realisateur-avec-ia) complète bien ce sujet.
...
C'est exactement ce que combat notre guide sur [images IA photoréalistes sans effet plastique](/blog/comment-generer-images-ia-photorealistes-sans-effet-plastique) : le **lisse** n'est pas une direction, c'est une absence de direction.
...
Pour des erreurs classiques de continuité en vidéo IA, lire [film IA : erreurs de raccord et incohérences visuelles à éviter](/blog/film-ia-erreurs-raccord-incoherences-visuelles-eviter).
...
Visages, doubles, sexualisation, stéréotypes : la DA porte une responsabilité sociétale qu'un outil ne peut pas assumer à ta place. Les cadres institutionnels existent pour raisonner ces sujets au delà du « joli ». L'[UNESCO et l'intelligence artificielle](https://www.unesco.org/en/artificial-intelligence) propose des repères éthiques larges. La [Commission européenne sur l'IA](https://digital-strategy.ec.europa.eu/en/policies/european-approach-artificial-intelligence) cadre aussi des attentes de transparence.
...
![Table lumineuse prints couleur et nuancier peinture, mains DA photoréaliste](/images/blog/limites-ia-direction-artistique/workflow-palette.webp)

## Limite 6 : la responsabilité légale et la copie inconsciente

Un générateur peut reproduire des motifs trop proches d'œuvres existantes. Le DA humain doit comprendre l'incertitude des données d'entraînement et des sorties. L'[OMPI : primer IA et PI](https://www.wipo.int/web-publications/wipo-primer-on-artificial-intelligence-and-ip/) aide à poser le vocabulaire. *Ce n'est pas une ligne juridique : c'est une ligne de prudence.*
...
1. Quel sentiment doit-on éprouver **après** l'image, pas pendant ?
2. Quelle information narrative devient **plus claire** ?
3. Qu'est ce qui est **interdit** dans ce projet et visible ici ?
4. Quelle preuve montre que ce n'est pas du stock générique ?
5. Que se passe t il si le client dit oui **trop vite** ? *Parfois c'est un signal que c'est trop lisse.*
